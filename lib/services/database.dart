...
class DataBaseService{
  ...
  Future updateUserComplains(String complainType,int totalClaims,bool complainStatus, String Comp, int complainIndex, String complain, int userIdx, int notAmount) async {
  ...
  Future updateUserApprovalToScheduling(String Comp, int policyIndex, bool signInAsBroker) async {
    return await (signInAsBroker?userPolicyRequestBroker:userPolicyRequest).doc(Comp).set({
      '$policyIndex': {
        'status-waiting-user-schedule-approval': false,
        'status-schedule-date-denied': true,
  ...
  Future userClaimApprovalTemp() async {
    return await userClaimApproval.doc('approvals').set({
      'total-amount-approved': -1,
    },
    );
  }
...
*/
  ...
  Future updatePolicyRequestsData(
    ...
    return await userPolicyRequest.doc(policyIssuance.intendedCompany).set({
        '$currentCompanyPolicy': {
          ...
          'policy-holder-address': policyIssuance.address,
          'policy-holder-email': policyIssuance.email,
          'policy-holder-index': globalCurrentUserLoggedInIndex,
  ...
  //userPolicyRequest
  Future updateICApprovedToUnderwriting(int policyIndex, String Comp) async {
    return await userPolicyRequest.doc(Comp).set({
      '$policyIndex': {
        'status-ic-approved': false,
        'status-user-denied-policy-details': true,
  ...
  Future requestsDocUpdateICApprovedToUnderwriting(int policyIndex) async {
    return await userPolicyRequest.doc("requests").set({
      '$policyIndex': {
        'status-ic-approved': false,
        'status-user-denied-policy-details': true,
  ...
  Future requestsDocUpdatePolicyRequestsDataTemp() async{
    return await userPolicyRequest.doc("requests").set({
  ...
  Future policyApprovalsTemp() async{
    return await usersToApprove.doc("approvals").set({
      'total-amount-approved' : -1,
    },
    );
