                  ...
                  if(snapshot.hasError){
                    ...
                    return Container(
                      child: ListView.builder(
                          itemCount: snapshot.data['company-amount']+2,
                          itemBuilder: (context, index){
                            if(index != 0){
                              if(snapshot.data['${index-1}']['full-insurance']){
                                return Padding(
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      ...
                                      Positioned(
                                        ...
                                        top: 20,
                                        child: FutureBuilder(
                                          future: _storage.getImage('insurance_companies','${index-1}.png'),
                                          builder:  (BuildContext context, AsyncSnapshot<dynamic> snapshot){
                                            if(snapshot.connectionState == ConnectionState.done){
                                              if(snapshot.hasError){
                                                return const Text("There is an error");
                                      ...
                                      Positioned(
                                        ...
                                        top: 20,
                                        child: Container(
                                          child: Text("${snapshot.data['${index-1}']['company-name']}",
                                            style: TextStyle(
                                              fontSize: 23,
                                              fontWeight: FontWeight.bold,
                                            ),),
                                    ...
                                    */
                                      ...
                                      Positioned(
                                        ...
                                        top: 80,
                                        child: Container(
                                          child: Text("Premium: ${snapshot.data['${index-1}']['company-premium']} EGP",style: TextStyle(
                                            fontSize: 20,
                                          ),),
                                        ),
                                      ),
                                          ...
                                          child: TextButton(
                                            onPressed: () {
                                              setState(() {
                                                ...
                                                insuranceCompanyName = snapshot.data['${index-1}']['company-name'];
                                                insuranceCompanyImage = firstCompanies[index-1].image;
                                                insuranceCompanyPrice =  int.parse(snapshot.data['${index-1}']['company-premium']);
                                                globalCurrentPolicyRequestAmount = int.parse(snapshot.data['${index-1}']['company-premium']);
                                                insuranceOptions = snapshot.data['${index-1}']['coverage-types'];
                                                globalCurrentInsuranceCompany = index-1;
                              ...
                              return Container(
                                ...
                                child: TextField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText: "Search for an insurance company",
                  ...
                  if(snapshot.hasError){
                    ...
                    return Container(
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index){
                            if(index != 0){
                              if(snapshot.data['${index-1}']['third-party']){
                                return Padding(
                                  padding: EdgeInsets.all(0),
                                  child: Stack(
                                    //alignment: Alignment.bottomCenter,
