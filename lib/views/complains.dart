...
class _ComplainsState extends State<Complains> {
  ...
  String selectedCompany = 'Gig Egypt';
  String selectedComplaintType = 'Policy Issuance';
  String complain = '';
        ...
        child: Center(
          child: Column(
            children: [
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: insuranceSelected?mainColor:Colors.blueGrey[100],
                  ...
                  Container(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                      color: insuranceSelected?Colors.blueGrey[100]:mainColor,
                      borderRadius: BorderRadius.circular(10),
                    ),
                    child: TextButton(
                      onPressed: (){
              ...
              SizedBox(height: 20,),
              buildDropDownMenu(companyList, selectedCompany, false),
              SizedBox(height: 30,),
              Text("Select Complaint Type", style: TextStyle(
                fontSize: 18,
              ),),
              SizedBox(height: 20,),
              buildDropDownMenu([
  ...
  Widget buildDropDownMenu(List<String> companyList, String selected, bool complainType){
    return Container(
      height: 30,
      width: 350,
        ...
        child: DropdownButton<String>(
          ...
          onChanged: (value){
            setState(() {
              selected = value!;
              if(complainType){
                selectedComplaintType = selected;
              }
              else{
