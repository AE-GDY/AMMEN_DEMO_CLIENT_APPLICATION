  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
          height: 1300,
              child:FutureBuilder(
                    future: Future.wait([requestsDocPolicyRequestsData(),policyApprovalData(),policyRequestsData(currentCompany),brokerPolicyRequestsData(currentBroker)]),
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        Positioned(
                                          top: 10,
                                          left: 160,
                                          child: Text("Pending Undewriting",
                                            style: TextStyle(
                                              fontSize: 18,
                                              fontWeight: FontWeight.bold,
                                            ),),
                                            ...
                                            child: Container(
                                              ...
                                              child: TextButton(
                                                onPressed: (){
                                                  ...
                                                  draftBrokerCompany = currentBroker;
