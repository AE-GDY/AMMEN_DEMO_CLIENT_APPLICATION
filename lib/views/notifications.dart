                              ...
                              child: Card(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      margin: EdgeInsets.all(10),
                                      child: Text(snapshot.data[0]['$globalCurrentUserLoggedInIndex']['notifications']['$index']['notification-sender'], style: TextStyle(
                                        fontSize: 20,
                                    ...
                                    Container(
                                      margin: EdgeInsets.all(10),
                                      child: Text("Comment: Fixes Complete", style: TextStyle(
                                          fontSize: 18
                                      ),),
                                    ),
                                    ...
                                    Container(
                                      margin: EdgeInsets.all(10),
                                      child: Text("Client share: ${snapshot.data[0]['$globalCurrentUserLoggedInIndex']['notifications']['$index']['client-coverage']} EGP"
                                      , style: TextStyle(
                                          fontSize: 18
                                        ),
                                      ),
