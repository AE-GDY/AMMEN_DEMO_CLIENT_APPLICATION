...
class _PaymentState extends State<Payment> {
  ...
  Future<Map<String, dynamic>?> brokerPolicyRequestsData(String brokerName) async {
    ...
    doc(currentBrokerToPay).get()).data();
  }
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(child: buildRatingCriteria(0,chosenRating0)),
                                    Expanded(child:buildRatingCriteria(1,chosenRating1)),
                                    Expanded(child:buildRatingCriteria(2,chosenRating2)),
                                    Expanded(child:buildRatingCriteria(3,chosenRating3)),
                                    Expanded(child:buildRatingCriteria(4,chosenRating4)),
                                    Expanded(child:buildRatingCriteria(5,chosenRating5)),
                                    Expanded(child:buildRatingCriteria(6,chosenRating6)),
                                    Expanded(child:buildRatingCriteria(7,chosenRating7)),
                                    Expanded(child:buildRatingCriteria(8,chosenRating8)),
                                    Expanded(child:buildRatingCriteria(9,chosenRating9)),
                                    Expanded(child:buildRatingCriteria(10,chosenRating10)),
                                    Expanded(child:buildRatingCriteria(11,chosenRating11)),
                                    Expanded(child:buildRatingCriteria(12,chosenRating12)),
                                    Expanded(child:buildRatingCriteria(13,chosenRating13)),
                                    Expanded(child:buildRatingCriteria(14,chosenRating14)),
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        FutureBuilder(
                                          future: Future.wait([requestsDocPolicyRequestsData(),policyApprovalData(),policyRequestsData(currentCompanyToPay),brokerPolicyRequestsData(currentBrokerToPay)]),
  ...
  Widget buildRatingCriteria(int index, List<bool> ratingList){
          ...
          Row(
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    color: ratingList[0]?Colors.blue:Colors.grey[200],
                  ),
                  width: 40,
                  height: 40,
                  child: TextButton(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    color: ratingList[1]?Colors.blue:Colors.grey[200],
                  ),
                  width: 40,
                  height: 40,
                  child: TextButton(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    color: ratingList[2]?Colors.blue:Colors.grey[200],
                  ),
                  width: 40,
                  height: 40,
                  child: TextButton(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    color: ratingList[3]?Colors.blue:Colors.grey[200],
                  ),
                  width: 40,
                  height: 40,
                  child: TextButton(
                ...
                Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(30),
                    color: ratingList[4]?Colors.blue:Colors.grey[200],
                  ),
                  width: 40,
                  height: 40,
                  child: TextButton(
